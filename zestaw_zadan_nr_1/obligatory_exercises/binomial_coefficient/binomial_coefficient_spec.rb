...
RSpec.describe BinomialCoefficient do
  ...
  describe '#recursive' do
    ...
    it { expect(dummy_class.recursive(100, 3)).to eq(161700) }
  end
  ...
  describe '#dynamic_programming' do
    ...
    it { expect(dummy_class.dynamic_programming(100, 3)).to eq(161700) }
    it { expect(dummy_class.dynamic_programming(1000, 4)).to eq(41417124750) }
  end
end
